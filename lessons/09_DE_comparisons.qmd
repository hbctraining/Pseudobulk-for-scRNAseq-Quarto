...
::: callout-tip
# [**Exercise 1**](09_DE_comparisons_Answer-key.qmd#exercise-1)
...
```{r}
#| label: combine_findmarkers_and_deseq2_results
...
```{r}
#| label: scatterplot_expression_Crebl2
...
```{r}
#| label: scatterplot_expression_Hist1h1d
...
```{r}
#| label: scatterplot_expression_Tiparp
