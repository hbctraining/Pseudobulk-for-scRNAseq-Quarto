...
::: callout-tip
# [**Exercise 1**](07_pseudobulk_DE_analysis_Answer-key.qmd#exercise-1)
...
```{r}
#| label: plot_dispersion_estimates
plotDispEsts(dds)
```
...
::: callout-tip
# [**Exercise 2**](07_pseudobulk_DE_analysis_Answer-key.qmd#exercise-2)
...
```{r}
#| label: return_results_names
# Return names for extracting results
resultsNames(dds)
```
...
::: callout-tip
# [**Exercise 3**](07_pseudobulk_DE_analysis_Answer-key.qmd#exercise-3)
