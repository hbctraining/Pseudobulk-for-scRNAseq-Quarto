...
```{r}
#| label: assign_metadata_to_object
...
---
collapse: true
title: Click here for alternative code for aggregating counts for multiple celltypes
---
...
::: callout-tip
# [**Exercise 1**](06_pseudobulk_DESeq2_Answer-key.qmd#exercise-1)
...
> Reminder: The abbreviations for the cell types can be found in the [project set-up lesson](02_setup_intro_dataset.qmd#celltype-annotation).
...
::: callout-tip
# [**Exercise 2**](06_pseudobulk_DESeq2_Answer-key.qmd#exercise-1)
