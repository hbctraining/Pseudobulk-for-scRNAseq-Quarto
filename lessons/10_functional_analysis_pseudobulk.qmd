...
```{r}
#| label: table_GO_upregulated
#| echo: false
# GO upregulated data table
datatable(cluster_summaryUp)
```
...
::: callout-tip
# [**Exercise 1**](10_functional_analysis_pseudobulk_Answer-key.qmd#exercise-1)
...
#| label: enrighmap_plot_GO_upregulated
...
```{r}
#| label: table_msigdb_results
#| echo: false
datatable(msigGSEA_results %>% arrange(-NES))
```
...
# [**Exercise 2**](10_functional_analysis_pseudobulk_Answer-key.qmd#exercise-2)
